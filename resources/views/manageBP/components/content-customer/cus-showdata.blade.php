                    ...
                    @if ($getUserData->date_cliam !== null)
                        <div class="mt-0 py-4 px-4 rounded bg-gray-100 text-sm">
                            <div class="flex justify-end">
                                <button class="bg-white bg-white rounded-full w-10 h-10 flex justify-center items-center" wire:click="openPopup({{ 0 }})">
                                    <i wire:loading.class="hidden" wire:target="openPopup({{ 0 }})" class="fa-solid fa-pen-to-square text-sm"></i>
