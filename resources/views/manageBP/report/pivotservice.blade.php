...
$objPHPExcel->getActiveSheet()->setCellValue('A1', 'เดือนที่รับรถ');
...
SUM(car_type='รถซื้อCKY')AS b_cky,SUM(car_type='รถซื้อWK')AS b_wk,SUM(car_type='อื่นๆ')AS other")->whereRaw("DATE_FORMAT(date_carin, '%Y-%c') = '".$year."-".$i."'")->get();
...
header('Content-Disposition: attachment;filename="pivotservice.xlsx"');
