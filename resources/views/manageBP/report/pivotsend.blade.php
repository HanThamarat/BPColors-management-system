		...
		array(
			...
			'fill' => array(
				...
				for($i=1;$i<13;$i++){
                    ...
                    SUM(car_type='รถซื้อCKY')AS b_cky,SUM(car_type='รถซื้อWK')AS b_wk,SUM(car_type='อื่นๆ')AS other")->whereRaw("DATE_FORMAT(date_send, '%Y-%c') = '".$year."-".$i."'")->get();
...
header('Content-Disposition: attachment;filename="pivotsend.xlsx"');
