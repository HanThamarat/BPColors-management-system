<x-fullcard>
    <div class="flex justify-start w-full gap-x-10">
        <div class="bg-gray-300 rounded-md w-1/3 flex justify-center items-center">
            <img src="{{ asset('img/tracking.png') }}" class="h-[350px] object-cover" alt="">
        </div>
        <div class="w-full w-4/5 relative">
            <div class="flex items-center gap-x-4">
                <div class="flex gap-x-3 items-center">
                    <img src="{{ asset('gif/box.gif') }}" class="h-[65px]" alt="">
                    <span class="text-[50px] font-prompt text-gray-400">รายการ</span>
                </div>
            ...
            <div class="w-full flex gap-x-2">
                <div class="w-full flex">
                    <input type="text" id="ProductNo" class="py-1 rounded-sm w-full border-none bg-gray-200 focus:outline-none focus:border-none" placeholder="รหัสสินค้า">
                ...
                <div class="flex">
                    <button type="button" id="search" class="px-5 bg-blue-500 py-1 rounded-sm text-white hover:bg-blue-400 duration-150 ease-in-out">
            ...
            <div id="htmlRender" class="w-full my-2">
...
@include('stock-color.content-view.content-stock.components.script')