<nav x-data="{ open: false }" class="bg-primary border-b border-gray-100">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-28">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                ...
                                @endphp
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border-white text-sm leading-4 font-medium rounded-md text-white bg-primary transition ease-in-out duration-150">
                                       <div class="mr-2 h-[40px] w-[40px] rounded-full bg-red-600 text-white flex justify-center items-center border-2 border-red-400">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('showbp') }}" :active="request()->routeIs('showbp')">
                {{ __('ข้อมูล BP') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('postreport') }}" :active="request()->routeIs('postreport')">
                {{ __('Report') }}
            </x-responsive-nav-link>
        </div>
